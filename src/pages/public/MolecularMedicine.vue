...
<template>
  <div class="flex min-h-screen bg-gray-50">
    <aside class="w-64 bg-white shadow-sm p-4">
      ...
      <nav class="mt-6 space-y-2 text-sm">
        <button class="w-full text-left p-2 rounded bg-blue-50 text-blue-700 font-medium">Метаболический профиль</button>
        <button class="w-full text-left p-2 rounded hover:bg-gray-100">Аналитика</button>
        <button class="w-full text-left p-2 rounded hover:bg-gray-100">Молекулярная медицина</button>
        <button class="w-full text-left p-2 rounded hover:bg-gray-100">Психофизиология</button>
        <button class="w-full text-left p-2 rounded hover:bg-gray-100">Биомеханика</button>
      </nav>
    </aside>
