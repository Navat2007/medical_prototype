  ...
  <main class="flex-1 flex flex-col gap-5">
    ...
    <div class="bg-white p-4 rounded-xl shadow-card flex flex-col gap-4">
      ...
      <div class="grid md:grid-cols-5 gap-4">
        ...
        <!-- График процента -->
        <div
            class="row-start-1 row-span-2 col-start-5 col-span-2 bg-white rounded-xl shadow-card p-4 flex flex-col items-center">
          <Doughnut :data="chartMassData" :options="chartOptions"/>
        </div>
      </div>
      ...
      <div class="grid md:grid-cols-3 gap-4">
        ...
        <div class="col-span-2 bg-white rounded-xl shadow-card p-4">
          ...
          <div class="flex gap-1 items-start p-4 rounded-lg bg-primary-100">
            ...
            <p class="text-sm text-muted-color">Относительное потребление O₂ (мл/мин/кг) позволяет сравнивать аэробную
              мощность спортсменов разного веса.</p>
          </div>
        </div>
      </div>
      <div class="grid md:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-4 bg-white rounded-xl shadow-card p-4">
          ...
          <div class="flex gap-1 items-start p-4 rounded-lg bg-secondary-100">
            ...
            <p class="text-sm text-muted-color">Анаэробный порог (АнП) - это интенсивность, при которой начинается
              накопление лактата в мышцах.</p>
          </div>
        </div>
        <!-- Показатели АэП -->
        <div class="flex flex-col gap-4 bg-white rounded-xl shadow-card p-4">
          ...
          <div class="flex gap-1 items-start p-4 rounded-lg bg-[#ecffed]">
            ...
            <p class="text-sm text-muted-color">Аэробный порог (АэП) - это интенсивность, выше которой метаболизм
              начинает смещаться от аэробного к анаэробному.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="p-3 rounded-lg bg-primary-100">
                <p class="text-xs text-primary-500">
                  RMR (Resting Metabolic Rate) - скорость метаболизма в состоянии покоя. RQ (Respiratory Quotient) -
                  дыхательный коэффициент, отражающий тип
        ...
        <div class="flex flex-col gap-4 bg-white p-4 rounded-xl shadow-card">
          ...
          <div class="p-4 rounded-lg bg-gray-100">
            <p class="text-sm text-muted-color">
              B-CrossLaps (CTX) - маркер резорбции костной ткани. Повышенный уровень может указывать на ускоренную
              костную резорбцию и риск потери костной массы.
            </p>
          </div>
        </div>
        <!-- Условия теста -->
