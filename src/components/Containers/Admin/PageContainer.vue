      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        <li class="inline-flex items-center">
          <router-link to="/admin/"
                       class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-600">
...
<style scoped>
.breadcrumb {
  @apply ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ms-2 dark:text-gray-400 dark:hover:text-primary-600;
}

.breadcrumb-last {
  @apply ms-1 text-sm font-medium text-primary-600 md:ms-2 dark:text-primary-600;
}
</style>